...
public class FormularioCRUDMoto extends JFrame implements ActionListener {
    ...
    public FormularioCRUDMoto() {
        ...
        lbId = new JLabel("Cedula Cliente:");
        lbName = new JLabel("Placa:");
        lbTel = new JLabel("Modelo:");
        lbDir = new JLabel("Numero de Motor:");
        ...
        String[] columnas = {"PLACA", "MODELO", "NUMERO DE MOTOR", "CEDULA CLIENTE"};
    ...
    public void setModelo(String telefono){
        
        this.txTel.setText(telefono);
        
    }
    
    public void setNMotor(String direccion){
    ...
    public void iniciarListeners(ActionListener listener){
        ...
        btnAgreagar.setActionCommand("FormularioMoto");
        btnEditar.setActionCommand("editarMotoM");
        btnDelete.setActionCommand("borrarMoto");
        btnListar.setActionCommand("listarMoto");
        btnUpdate.setActionCommand("actualizarMoto");
